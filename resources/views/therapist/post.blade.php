...
<body>
    <div class="vh-10 vw-100 bg-main d-flex align-items-center justify-content-between px-2">
        <div>
            <a class="btn p-1 btn-hover-second" role="button" href="{{url('therapist/peer_chat')}}">
    ...
    <div class="py-4 d-flex justify-content-center">
        <div class="col-md-8 col-lg-6">
            <div class="mb-5">
                ...
                @if ($post->image_url)
                    <div>
                        <a href="{{url('therapist/kuhes_chat/post/'.$post->id)}}">
                ...
                <div id="comment-section">
                            ...
                            <div class="col-11">
                                ...
                                <div class=".reply-div">
                                    ...
                                    <div class="replies d-none">
                                            ...
                                            @forelse ($replies as $reply)
                                                @if($reply->comment_id == $comment->id)
                                                    <div class="reply row mb-2">
                                                        <div class="col-1 text-center">
                                                            <i class="fas fa-user-circle fs-1 @if($user->where('id',$reply->user_id)->value('user_type') == 'therapist') color-second @else color-main @endif"></i>
                                                        </div>
                                                        <div class="col-11">
                                                            <a href="#"></a>
                                                            <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <form method="post" action="{{url('therapist/peer_chat/reply_on_post_comment/'.$comment->id)}}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-10">
                    ...
                    <div>
                        <form method="post" action="{{url('therapist/peer_chat/post/'.$post->id.'/post_comment')}}">
                            @csrf
                            <div class="row">
                                <div class="col-10">
