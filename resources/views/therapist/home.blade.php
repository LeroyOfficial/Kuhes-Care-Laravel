...
<body>
    <div id="top-bar" class="p-2 p-md-4 vh-10 d-flex align-items-center justify-content-between">
        <div>
            <a class="d-flex align-items-center" href="{{url('therapist/dashboard')}}">
    ...
    <div class="overflow-auto bg-grey border-second border-top border-2">
        ...
        <div class="row row-cols-md-2 row-cols-lg-4 p-2 justify-content-between text-center">
                ...
                <div class="bg-white p-4 rounded-3 border-1 shadow-sm">
                    {{-- @if ($unread_messages->count()  > 0)
                        <div class="text-end mb-2">
                            <span class="chat-new-message-count bg-main rounded-circle px-1 top-50">{{$unread_messagescount()}}</span>
                        </div>
                    @endif --}}

                    <div class="text-center mb-3">
                        <a href="{{url('therapist/chats')}}">
                    ...
                    <p>This is where you can talk to clients who need help</p>
                </div>
            </div>
            <div class="p-2">
                <div class="bg-white p-4 rounded-3 border-1 shadow-sm">
                    <div class="text-center mb-3">
                        <a href="{{url('therapist/peer_chat')}}">
                    ...
                    <div class="text-center">
                        <a href="{{url('therapist/peer_chat')}}">
                            <h4>Posts</h4>
                            <p>This is where you comment on Peer posts from clients</p>
                        </a>
                    </div>
                </div>
            </div>
            <div class="p-2">
                <div class="bg-white p-4 rounded-3 border-1 shadow-sm">
                    ...
                    <div class="text-center">
                        <a href="{{url('therapist/books')}}">
                            <h4>Books</h4>
                            <p>This is where you can publish motivational books for clients to read</p>
                        </a>
                    </div>
                </div>
            </div>
            <div class="p-2">
                <div class="bg-white p-4 rounded-3 border-1 shadow-sm">
                    ...
                    <div class="text-center">
                        <a href="{{url('therapist/videos')}}">
                            <h4>Videos</h4>
                            <p>This is where you can post motivational videos for clients to watch</p>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="p-2">
                <div class="bg-white p-4 rounded-3 border-1 shadow-sm">
                    <div class="text-center mb-3">
                        <a href="{{url('therapist/appointments')}}">
                            <img class="vh-30" src="{{asset('assets/img/15279937.jpg')}}">
                        </a>
                    </div>
                    <div class="text-center">
                        <a href="{{url('therapist/appointments')}}">
                            <h4>Appointments</h4>
                            <p>This is where you can check people who have booked your appointment</p>
                        </a>
                    </div>
                </div>
            </div>
