...
<body>
    <div class="vh-10 vw-100 bg-main d-flex align-items-center justify-content-between px-2">
        <div>
            <a class="btn p-1 btn-hover-second" role="button" href="{{url('user/videos')}}">
    ...
    <div class="d-flex justify-content-center px-2 py-3 mb-2">
        <div>
            ...
            <div id="search-video-list" class="d-none position-absolute bg-white p-1 vw-30 rounded" style="z-index:10;"></div>
        </div>
    </div>
    <div class="row py-4">
        <div class="col-md-8">
            ...
            <div id="comment-section">
                            ...
                            <div class="col-11">
                                ...
                                <div class=".reply-div">
                                    ...
                                    <div class="replies d-none">
                                        ...
                                        <div>
                                            <form method="post" action="{{url('user/reply_on_video_comment/'.$comment->id)}}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-10">
                ...
                <div>
                    <form method="post" action="{{url('user/video/'.$video->id.'/post_comment')}}">
                        @csrf
                        <div class="row">
                            <div class="col-10">
        ...
        <div class="col-md-4">
            ...
            @forelse ($other_videos as $video)
                <div id="suggested-video-1" class="row p-1 mb-2">
                    <div class="col-4 p-0">
                        <img class="w-100 h-100" src="{{asset('Video_Thumbnails/'.$video->thumbnail_url)}}">
                    </div>
                    <div class="col-8">
                        <a class="fw-semibold color-main" href="{{url('user/watch_video/'.$video->id)}}">{{$video->title}}</a>
                        <div>
                            <a class="color-second fw-semibold" href="{{url('user/therapist/'.$video->therapist_id)}}">
                                Therapist -
                                {{$therapist->where('id',$video->therapist_id)->value('first_name')}}
            ...
            @empty
                <div class="text-center">
                    <h4>
                        There other videos found
                    </h4>
                    <h5>more videos will be posted soon</h5>
                </div>
            @endforelse
