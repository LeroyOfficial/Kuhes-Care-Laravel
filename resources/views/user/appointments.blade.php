    ...
    <div class="row justify-content-center py-5">
        <div class="col-md-8">
            <div class="d-flex justify-content-between mb-4">
                <h4>Appointments</h4>
                <a class="btn btn-bg-main" role="button" href="{{url('user/new_appointment')}}">Book a new Appointment</a>
            </div>
            ...
            <div class="table-responsive">
                <table  id="table1" class="table">
                    <thead>
                        <tr>
                            <td style="background-color: var(--color-main); color:white;">Therapist</td>
                    ...
                    <tbody>
                        ...
                        @php
                            $therapist = $therapists->where('id',$appointment->therapist_id)->first();
                        @endphp
                            <tr>
                                <td>
                                    <a href="{{url('user/appointment/'.$appointment->id)}}">{{$therapist->first_name}} {{$therapist->last_name}}</a>
                                </td>
                                <td>
                                    {{$appointment->topic}}
                                </td>
